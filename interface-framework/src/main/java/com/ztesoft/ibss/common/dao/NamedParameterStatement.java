...
/**
 * This class wraps around a {@link java.sql.PreparedStatement} and allows the
...
public class NamedParameterStatement {
     ...
     * c.{@link java.sql.Connection#prepareStatement(String)
     * prepareStatement}.
     *
     * @param connection
     ...
     *
     * @return true if the first result is a {@link java.sql.ResultSet}
     * @throws java.sql.SQLException
     *             if an error occurred
