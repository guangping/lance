 ...
 * {@link com.ztesoft.inf.extend.xstream.XStream} facade, you can register
 * new converters using the XStream.registerConverter() method.
 * </p>
 * <p/>
 * <p>
 * If working with the lower level API, the
 * {@link com.ztesoft.inf.extend.xstream.converters.ConverterLookup}
 * implementation is responsible for looking up the appropriate converter.
 * </p>
 * <p/>
 * <p>
 ...
 * <p/>
 * <p>
 * {@link com.ztesoft.inf.extend.xstream.converters.collections.AbstractCollectionConverter}
 * provides a starting point for objects that hold a collection of other objects
 * (such as Lists and Maps).
 * </p>
 * 
 * @author Joe Walnes
 * @see com.ztesoft.inf.extend.xstream.XStream
 * @see com.ztesoft.inf.extend.xstream.converters.ConverterLookup
 * @see com.ztesoft.inf.extend.xstream.converters.basic.AbstractSingleValueConverter
 * @see com.ztesoft.inf.extend.xstream.converters.collections.AbstractCollectionConverter
 */
