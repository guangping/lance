...
public class Dom4JWriter extends AbstractDocumentWriter {
	 ...
	 * @since 1.2.1
	 */
	public Dom4JWriter(final Branch root, final DocumentFactory factory,
	 ...
	 * @since 1.2.1
	 */
	public Dom4JWriter(final DocumentFactory factory,
			final XmlFriendlyReplacer replacer) {
	...
	protected Object createNode(final String name) {
		final Element element = documentFactory
				.createElement(escapeXmlName(name));
