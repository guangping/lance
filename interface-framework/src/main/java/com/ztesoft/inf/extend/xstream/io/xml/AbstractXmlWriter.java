...
/**
 * Abstract base implementation of HierarchicalStreamWriter that provides common
 * functionality to all XML-based writers.
 * 
 * @author Mauro Talevi
 * @since 1.2
 */
public abstract class AbstractXmlWriter implements
		ExtendedHierarchicalStreamWriter, XmlFriendlyWriter {
