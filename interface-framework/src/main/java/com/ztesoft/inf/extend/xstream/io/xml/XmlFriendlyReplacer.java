...
/**
 * Allows replacement of Strings in XML-friendly drivers. The default
 * replacements are:
 * <ul>
 * <li><b>$</b> (dollar) chars are replaced with <b>_-</b> (underscore dash)
 * string.<br>
 * </li>
 * <li><b>_</b> (underscore) chars are replaced with <b>__</b> (double
...
public class XmlFriendlyReplacer {
	...
	/**
	 * Unescapes name re-enstating '$' and '_' when replacement strings are
	 * found
	 * 
	 * @param name
	 *            the name of attribute or node
	...
	public String unescapeName(String name) {
		...
		if (s == null) {
			...
			final char underscoreReplacementFirstChar = underscoreReplacement
					.charAt(0);
			final int length = name.length();
