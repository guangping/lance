 ...
 * <p>
 * SimpleDateFormat has a high overhead in creating and is not thread safe. To
 * make best use of resources, the ThreadSafeSimpleDateFormat provides a
 * dynamically sizing pool of instances, each of which will only be called by a
...
public class ThreadSafeSimpleDateFormat {
	...
	public ThreadSafeSimpleDateFormat(String format, int initialPoolSize,
