 ...
 * <p/>
 * Can newInstance: classes with public visibility, outer classes, static inner
 * classes, classes with default constructors and any class that implements
 * java.io.Serializable. Cannot newInstance: classes without public visibility,
 * non-static inner classes, classes without default constructors. Note that any
 * code in the constructor of a class will be executed when the ObjectFactory
